...
nrou_df = pd.read_csv(r"...\Data\Raw Data\Other Variables\Unemployment\Noncyclical_Rate_of_Unemployment.csv")
...
unrate_df = pd.read_csv(r"...\Data\Raw Data\Other Variables\Unemployment\UNRATE.csv")
unrate_df = adding_date_variables(unrate_df)

unrate_df.to_csv('unrate_m_df.csv', index = False)

#%% Consumer Sentiment
consumer_sentiment_df = pd.read_csv(r"...\Data\Raw Data\Other Variables\Consumer Sentiment\Consumer Sentiment.csv")
...
#%% CPI Inflation
cpi_df = pd.read_csv(r"...\Data\Raw Data\Other Variables\CPI\CPI.csv")
cpi_df = adding_date_variables(cpi_df)

cpi_df.to_csv('cpi_m_df.csv', index = False)

#%% Interest rate
interest_rate_df = pd.read_csv(r"...\Data\Raw Data\Other Variables\FED FUND\FEDFUNDS.csv")
interest_rate_df = adding_date_variables(interest_rate_df)

interest_rate_df.to_csv('interest_rate_m_df.csv', index = False)

#%% M2 Money Supply
m2_df = pd.read_csv(r"...\Data\Raw Data\Other Variables\Money supply\M2.csv")
m2_df = adding_date_variables(m2_df)

m2_df.to_csv('m2_m_df.csv', index = False)

#%% Recession indicator
recession_dummy_df = pd.read_csv(r"...\Data\Raw Data\Other Variables\Recession\Recession_Indicators.csv")

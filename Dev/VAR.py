...
"""
DISCLAIMER: The hash commented loop was intended to run a rolling windown cross-validation type of VAR, but we changed our minds and used the VAR model solely for deciding how many lags we should add to the data.
"""
